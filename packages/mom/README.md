...
- run interactive coding agent session: `npx @hirocode/coding-agent`
- enter `/login` command
...
Update mom anytime with `npm install -g @hirocode/mom`. This only updates the Node.js app on your host. Anything mom installed inside the Docker container remains unchanged.
