...
import { Agent, type AgentMessage, type ThinkingLevel } from "@hirocode/agent-core";
import type { Message, Model } from "@hirocode/ai";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.hirocode/agent */
	agentDir?: string;
	...
	/** Built-in tools to use. Default: codingTools [read, bash, edit, write, webfetch, websearch, task, todowrite] */
	tools?: Tool[];
