import type { Transport } from "@hirocode/ai";
...
export type ShellKindSetting = "cmd" | "powershell" | "bash";
...
export interface Settings {
	...
	shellKind?: ShellKindSetting; // Preferred shell family for command execution
...
export class SettingsManager {
	...
	getShellKind(): ShellKindSetting | undefined {
		return this.settings.shellKind;
	}

	setShellKind(kind: ShellKindSetting | undefined): void {
		this.globalSettings.shellKind = kind;
		this.markModified("shellKind");
		this.save();
	}
