...
import {
	...
	CONFIG_DIR_NAME,
	ENV_AGENT_DIR,
	ENV_AGENT_DIR_LEGACY,
	ENV_OFFLINE,
	ENV_OFFLINE_LEGACY,
	ENV_PACKAGE_DIR,
	ENV_PACKAGE_DIR_LEGACY,
	ENV_SHARE_VIEWER_URL,
	ENV_SHARE_VIEWER_URL_LEGACY,
} from "../config.js";
...
${chalk.bold("Options:")}
  ...
  --benchmark-mode               Use the non-interactive benchmark runtime profile
...
${chalk.bold("Examples:")}
  ...
  # Enable benchmark-oriented non-interactive runtime behavior
  ${APP_NAME} --benchmark-mode -p "Fix the failing tests and verify the result"
