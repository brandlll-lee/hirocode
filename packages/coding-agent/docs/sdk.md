...
```bash
npm install @hirocode/coding-agent
```
...
```typescript
import { createAgentSession } from "@hirocode/coding-agent";
...
The `Agent` class (from `@hirocode/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@hirocode/coding-agent";
...
```typescript
import {
  codingTools,   // read, bash, edit, write, webfetch, websearch (default)
  readOnlyTools, // read, grep, find, ls
  readTool, bashTool, editTool, writeTool, webFetchTool, webSearchTool,
  grepTool, findTool, lsTool,
} from "@hirocode/coding-agent";
...
```typescript
import {
  createCodingTools,    // Creates [read, bash, edit, write, webfetch, websearch] for specific cwd
...
import { createAgentSession, type ToolDefinition } from "@hirocode/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, SessionManager } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, InteractiveMode } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, runPrintMode } from "@hirocode/coding-agent";
...
```typescript
import { createAgentSession, runRpcMode } from "@hirocode/coding-agent";
