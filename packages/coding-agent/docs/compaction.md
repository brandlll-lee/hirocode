...
For TypeScript definitions in your project, inspect `node_modules/@hirocode/coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@hirocode/coding-agent";
