...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@hirocode/ai`, `@hirocode/agent-core`, `@hirocode/coding-agent`, `@hirocode/tui`, `@sinclair/typebox`.
