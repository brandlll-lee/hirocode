...
| Package | Purpose |
|---------|---------|
| `@hirocode/coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@hirocode/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@hirocode/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@hirocode/coding-agent";
...
```typescript
import { isBashToolResult } from "@hirocode/coding-agent";
...
```typescript
import { createLocalBashOperations } from "@hirocode/coding-agent";
...
```typescript
import { Type } from "@sinclair/typebox";
import { StringEnum } from "@hirocode/ai";
...
```typescript
import type { AutocompleteItem } from "@hirocode/tui";
...
```typescript
import { withFileMutationQueue } from "@hirocode/coding-agent";
...
**Important:** Use `StringEnum` from `@hirocode/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@hirocode/coding-agent";
...
```typescript
import { createBashTool } from "@hirocode/coding-agent";
...
```typescript
import { keyHint } from "@hirocode/coding-agent";
...
```typescript
import { Text, Component } from "@hirocode/tui";
...
import { matchesKey } from "@hirocode/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@hirocode/coding-agent";
