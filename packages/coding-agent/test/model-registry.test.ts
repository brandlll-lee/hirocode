...
import type { Api, Context, Model, OpenAICompletionsCompat } from "@hirocode/ai";
import { getApiProvider } from "@hirocode/ai";
import { getOAuthProvider } from "@hirocode/ai/oauth";
