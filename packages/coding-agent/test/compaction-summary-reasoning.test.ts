...
import type { AssistantMessage, Model } from "@hirocode/ai";
...
vi.mock("@hirocode/ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@hirocode/ai")>();
	return {
		...actual,
