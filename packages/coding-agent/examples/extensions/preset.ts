...
import type { ExtensionAPI, ExtensionContext } from "@hirocode/coding-agent";
import { DynamicBorder, getAgentDir } from "@hirocode/coding-agent";
import { Container, Key, type SelectItem, SelectList, Text } from "@hirocode/tui";
