...
const decodeParts = (parts: string[]) => decode(parts.join(""));
const CLIENT_ID = decodeParts([
	"MTA3MTAwNjA2MDU5MS10bWhzc2luMmgyMWxjcmUyMzV2dG9s",
	"b2poNGc0MDNlcC5hcHBzLmdvb2dsZXVzZXJjb250ZW50LmNvbQ==",
]);
const CLIENT_SECRET = decodeParts(["R09DU1BYLUs1OEZXUjQ4NkxkTEox", "bUxCOHNYQzR6NnFEQWY="]);
