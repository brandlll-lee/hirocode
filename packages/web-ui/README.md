...
Reusable web UI components for building AI chat interfaces powered by [@hirocode/ai](../ai) and [@hirocode/agent-core](../agent).
...
```bash
npm install @hirocode/web-ui @hirocode/agent-core @hirocode/ai
```
...
```typescript
import { Agent } from '@hirocode/agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@hirocode/web-ui';
import '@hirocode/web-ui/app.css';
...
declare module '@hirocode/agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@hirocode/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@hirocode/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@hirocode/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@hirocode/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@hirocode/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@hirocode/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@hirocode/web-ui';
...
```typescript
import { SessionListDialog } from '@hirocode/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@hirocode/web-ui';
...
```typescript
import { ModelSelector } from '@hirocode/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@hirocode/web-ui';
